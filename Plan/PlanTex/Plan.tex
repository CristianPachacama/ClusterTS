...
\multirow{5}{5em}{Obtención de Datos} 
 & Descarga de Bases de Datos Meteorológicos Brasil – Fuente: Banco de Datos Meteorológicos (CPTEC).\\ 
 & Descarga de Bases de Datos Hídricos Brasil – Fuente: Operador Nacional do Sistema Elétrico Brasil (ONS).\\ 
 & Descarga de Bases de Datos Meteorológicos Globales (Series de Tiempo de índices meteorológicos) - Fuente: National Weather Service (NOAA). \\ 
 & Descarga de Bases de Datos Meteorológicos Globales (Series de Tiempo de variables meteorológicos) - Fuente: Global Climate Observing System (GCOS).\\
 & Descarga de Bases de Datos Meteorológicos Globales (Datos meteorológicos y de clima) - Fuente: Climatic Reserch Unit.\\
 \hline
